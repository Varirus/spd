...
int main(int argc, char *argv[])
{
    ...
    int sort_r_error_sum = 0;
    int sort_q_error_sum = 0;
    int schrage_error_sum = 0;
    int preemptiveSchrage_error_sum = 0;
    int carlier_error_sum = 0;
    int ownAlgorithm_error_sum = 0;
    int ownAlgorithm2_error_sum = 0;
    ...
    printf("Error sredni Preemptive Schrage: %d\n", preemptiveSchrage_error_sum / count);
    ...
    printf("Error sredni Own Algorithm: %d\n", ownAlgorithm_error_sum / count);
    ...
    printf("Error sredni Own Algorithm 2: %d\n", ownAlgorithm2_error_sum / count);
